  ...
  return (
    <nav className={`navbar navbar-expand-lg`} style={getMode(props.mode)}>
      <div className="container-fluid">
        {/* <Link className="navbar-brand" to="/" style={{color:getMode(props.mode).color}}>{props.title}</Link> */}
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              {/* <Link className="nav-link active" aria-current="page" to="/" style={{color:getMode(props.mode).color}}>{props.nav1}</Link> */}
              <a className="nav-link active" aria-current="page" href="#" style={{color:getMode(props.mode).color}}>{props.nav1}</a>
            </li>
            {/* <li className="nav-item">
              <Link className="nav-link active" to="/about" style={{color:getMode(props.mode).color}}>{props.nav2}</Link>
            </li> */}
